...
namespace NDP\Question\Block\Adminhtml\Product;
...
class Grid extends \Magento\Catalog\Block\Adminhtml\Product\Grid
{
    ...
    {
        parent::_construct();
        $this->setRowClickCallback('question.gridRowClick');
        $this->setUseAjax(true);
    }

    /**
     * Prepare product question grid
     *
     * @return void
     */
    ...
    {
        return $this->getUrl('question/product/productGrid', ['_current' => true]);
    }
    ...
    {
        return $this->getUrl('question/product/jsonProductInfo', ['id' => $row->getId()]);
    }
